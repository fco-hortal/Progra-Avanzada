...
def distraer(alumno, ayudante):
    #if comida_alumno == comida_ayudante:
        #return True
    pass
...
if __name__ == '__main__':
    alumnos = cargar.cargar_alumnos(os.path.join('bases_datos', 'alumnos.csv'))
    ayudantes = cargar.cargar_ayudantes(os.path.join('bases_datos', 'ayudantes.csv'))
